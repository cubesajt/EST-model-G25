...
Flowrate = 120 / 60000; % flow rate of fluid (m^3 / s)
Length = 0.3; % length of the pipe (m)
Density = 1.225; % density of the fluid (kg/m^3)
Diameter = 0.004; % diameter of the pipe (m)
Roughness = 0.0015 * 10 ^ (-6); % pipe roughness coefficient (m)
